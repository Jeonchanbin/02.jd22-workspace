...
public class Java03 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("문자길이는?"+myFace.length());
        // 4.문자열 메서드
        ...
        // 대소문자를 구분, 찾는문자열 없으면 -1리턴, 0부터 셈
        System.out.println("Handsome문자열시작위치:"+myFace.indexOf("Handsome"));
        System.out.println("handsome문자열시작위치:"+myFace.indexOf("handsome")); //없으면 -1
        
        // 6. 문자열 연결
        // suvstring(시작순번, 끝수번 다음 순번)
        System.out.println("Hand만 잘라서 가져오기"+myFace.substring(10,14));
        // 6. 문자열 연결
        // + 연산자를 문자열 사이에 사용하여 결합
        
        // 7. 문자열 일부 변경하기
        // replace(바꿀문자열, 바뀔 문자열)
        ...
        System.out.println("나야나 열번 반복하기 : "+nayana.repeat(10));
        ...
        System.out.println("10.1rhk 10.11 중 큰 것은?"+Math.max(10.1 , 10.11));
